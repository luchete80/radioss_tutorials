...
#Put on list...
out_x = open('movo_x.inc',"w")
out_y = open('movo_y.inc',"w")
out_z = open('movo_z.inc',"w")


file = open('myToolpath_botToolTipPnts.csv')
...
out_x.write("/FUNCT/1000004\nmovx\n")    
out_y.write("/FUNCT/1000005\nmovy\n")      
out_z.write("/FUNCT/1000006\nmovz\n")   
...
out_z.write(writeFloatField(t_interf,20,10) + writeFloatField(zo, 20,10) + "\n")
...
for i in range (2, len(data)) :
  ...
  if (dist > 1.0e-5):
    ...
    out_z.write(writeFloatField(t*60.0+t_interf,20,10) + writeFloatField(zo,20,10) + "\n")
  else:
